        ...
        <Toolbar>
          <Typography variant="h6" className={classes.title}>
            ...
            <ul className={classes.List}>
              ...
              <li className={classes.itemList}><NavLink to="/NewArticle" className={classes.link}><i className={`${classes.iFont} fas fa-newspaper`}></i> New Artical</NavLink></li>
              ...
              <li className={classes.itemList}><NavLink to="/Profile" className={classes.link}><i className={`${classes.iFont} fas fa-user-circle`}></i> Profile</NavLink></li>
